...
<div class="flex flex-col md:flex-row gap-5 shadow-lg px-2 bg-white py-2 rounded-lg w-full md:w-[32%]">
    <div class="flex w-full md:w-[35%] items-center">
        <a href="{{ asset('storage/img/jpg/school/'.$catalog->img_name.'.'.$catalog->img_ext ) }}" class="hover:scale-105 transition duration-300 ease-in" target="_blank">
            <div class="w-[100%] h-40 rounded-md">
                <img src="{{ asset('storage/img/jpg/school/'.$catalog->img_name.'.'.$catalog->img_ext ) }}" alt="picture" class="h-full w-full rounded-[100%]">
            </div>
        </a>
    </div>
    <div class="flex flex-col gap-1 py-2 space-y-1 w-full md:w-[65%] my-auto">
        ...
        <div class="flex flex-col space-y-1">
            ...
            <div class="flex flex-wrap gap-2">
                <a href="https://wa.me/{{ $contact->whatsapp }}?text=Hello%20good%20day,%0A%0AI%20will%20like%20to%20enquire%20about%20this%20*{{ $catalog->product_name }}* %0AWith the image link below %0A {{ asset('storage/img/jpg/school/'.$catalog->img_name.'.'.$catalog->img_ext ) }}" class="px-2 py-1 hover:scale-125 hover:border-green-700 transition duration-300 ease-in text-xs text-green-600 rounded flex justify-center items-center" target="_blank">
