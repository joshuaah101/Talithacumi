...
<div class="flex flex-col md:flex-row gap-1 shadow-lg px-2 bg-white py-2 rounded-lg w-full md:w-[32%]">
    <div class="flex w-full md:w-1/2">
        <a href="{{ asset('storage/img/jpg/kids/'.$catalog->img_name.'.'.$catalog->img_ext ) }}" class="border-[5px] hover:scale-105 transition duration-300 ease-in rounded-[50%]" target="_blank">
            <img src="{{ asset('storage/img/jpg/kids/'.$catalog->img_name.'.'.$catalog->img_ext ) }}" alt="picture" class="w-64 h-48 md:h-full md:w-full rounded-[50%]">
        </a>
    </div>
