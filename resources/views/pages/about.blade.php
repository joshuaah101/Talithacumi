...
@section('body')
    ...
    <header class="flex sm:max-w-screen-sm md:max-w-screen-md lg:max-w-screen-lg xl:max-w-screen-xl 2xl:max-w-screen-2xl min-h-[60vh] md:min-h-[55vh] items-center justify-center mx-auto px-8 bg-gradient-to- from-[#CC9E5A] via-white to-[#CC9E5A] rounded-bl-md rounded-br-md">
        <div class="flex flex-col space-y-12 justify-center items-center">
            <img src="{{ asset('storage/img/png/logo.png') }}" alt="" class="w-20 md:w-40">
            <div class="flex flex-col space-y-8">
                <h1 class="text-xl md:text-5xl text-center text-amber-900 font-semibold">
                    {{ config('app.name') }}
                </h1>
    ...
    <main class="sm:max-w-screen-sm md:max-w-screen-md lg:max-w-screen-lg xl:max-w-screen-xl 2xl:max-w-screen-2xl mx-auto my-8 space-y-10 px-5 md:px-0">
        <section class="flex flex-col space-y-5 bg-white shadow-lg rounded-md px-8 md:px-16 py-10">
            <header class="text-xl md:text-2xl font-semibold text-gray-800 text-center">
                About Us !
                <hr class="border mt-2">
            </header>

            <p class="leading-normal text-lg">
                {{ config('app.name') }} is a leading interior design business company based in Ogun state. We specialize in creating bespoke, high-end designs for residential and commercial projects with over a decade of experience, our team of talented designers, will help you bring your visions to reality.
            </p>
        </section>
        ...
        <section class="flex flex-col md:flex-row w-full md:space-x-10 space-y-8 px-2 md:px-16 py-10 items-center">
            ...
            <div class="flex flex-col space-y-2 w-full md:w-[75%]">
                ...
                <p class="leading-normal text-base md:text-lg">
                    Hello! My name is Olusola Ogungbade, I am the founder of {{ config('app.name') }} A unique interior design business company based in Ogun state. We specialize in merging traditional and contemporary design elements, to create stunning and functional spaces. Our team of experienced designers is highly skilled in understanding the needs of our clients and providing them with solutions that are tailored to their individual requirements. At {{ config('app.name') }}, we believe in creating a unique experience for our clients, we strive to make every project a positive one. We offer our clients a wide range of services to ensure that space is transformed into their dream home.

                    <p class="leading-normal text-base md:text-lg">
                        Initially, {{ config('app.name') }} started her operation in 2008 and was known at the time  as <em>SHODEX FURNITURE</em>. Later, we incorporated with the Corporate Affairs Commision (CAC) in the year 2020 (13<sup>th</sup> of November to be precise) and then rebranded to be known as {{ config('app.name') }}.
                    </p>
                </p>
            </div>
        </section>

        <section class="flex flex-col space-y-5 w-full px-8 md:px-16 py-10 bg-white shadow-lg rounded-md">
            <header class="text-xl md:text-2xl font-semibold text-gray-800 text-center">
                Mission
                <hr class="border mt-2">
            </header>
            <p class="leading-normal text-lg">
                At Talithacumi Global Concept, we create exceptional custom woodwork with a commitment to craftsmanship, sustainability, and customer satisfaction, while positively impacting our community and the environment.
            </p>
        </section>

        <section class="flex flex-col space-y-8 w-full px-8 md:px-16 py-10">
            <header class="text-xl md:text-2xl font-semibold text-gray-800 text-center">
                Vision
                <hr class="border mt-2 border-gray-300">
            </header>
            <p class="leading-normal text-lg">
                Talithacumi Global Concept aims to be the premier destination for bespoke woodwork, recognized for our excellence, innovation, and traditional craftsmanship, inspiring spaces and enriching lives.
            </p>
        </section>

        <section class="flex flex-col md:flex-row w-full items-center md:h-[23rem] md:relative">
            <div class="hidden md:flex w-full md:w-2/5 bg-white flex-col space-y-5 py-10 px-8 md:z-0 md:absolute md:left-10 rounded-tr-full rounded-br-full">
                <header class="text-xl font-semibold text-gray-800">
                    Our services includes the following
                    <hr class="border mt-1">
                </header>
                <ul class="text-base">
                    {{-- <li>- Antique Restoration</li> --}}
                    <li>- Upholstery Restoration</li>
                    <li>- Wood Refinishing</li>
                    <li>- Interior and Exterior</li>
                    <li>- 3D Epoxy Design</li>
                    <li>- 3D House Modelling</li>
                    <li>- Architectural Planning</li>
                    <li>- Space Planning</li>
                </ul>
            </div>
            <div class="flex bg-no-repeat bg-cover bg-fixed bg-center h-screen md:h-[23rem] px-2 py-6 my-8 rounded w-full md:w-3/5 justify-center items-center flex-col md:flex-row md:-z-10 md:absolute md:right-10" style="background-image: linear-gradient(to bottom, rgba(20, 3, 3, 0.49), rgba(8, 8, 34, 0.712)),url('{{ asset('storage/img/jpg/parallax/bg-parallax-5.jpg'); }}')">
                <div class="uppercase text-lg md:text-3xl text-gray-100 font-bold">
                    Our services
                </div>


                <ul class="flex flex-col space-y-2 px-2 md:hidden w-full mt-5 text-base text-gray-100">
                    <span class="inline md:hidden">We are specilized in woodwork services which includes:</span>
                    {{-- <li>- Antique Restoration</li> --}}
                    <li>- Upholstery Restoration</li>
                    <li>- Wood Refinishing</li>
                    <li>- Interior and Exterior</li>
        ...
        <section class="flex flex-col space-y-5 w-full rounded-lg">
            <header class="text-center text-xl font-semibold ">
                Check us on Google map
            </header>

            <div class="w-full h-min-[450px]">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1979.4971796701393!2d3.366928901249323!3d7.126647712226482!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x103a4ba38f5ba82d%3A0x938ea2daae97a674!2sIjeun-Lukosi%20Bus%20Stop!5e0!3m2!1sen!2sng!4v1681813431243!5m2!1sen!2sng" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade" class="w-full min-h-[450px] rounded-lg shadow-lg"></iframe>
            </div>
        </section>
        ...
        <section class="flex flex-col space-y-5 w-full px-8 md:px-16 py-10 bg-white shadow-lg rounded-md">
            ...
            <div class="flex flex-col md:flex-row gap-5 md:gap-16 w-full p-4 md:p-8">
                @foreach ($certifications as $cert)
                    <div class="w-full md:w-2/3 flex justify-center shadow-xl shadow-gray-400 rounded-md">
                        <img src="{{ asset('storage/img/jpg/profile/'.$cert->img_name.'.'.$cert->img_ext) }}" alt="" class="w-full">
                    </div>
                @endforeach
            </div>
        </section>
